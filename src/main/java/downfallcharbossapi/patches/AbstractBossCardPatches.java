...
import downfallcharbossapi.callback.OverwriteCardBackground;
import downfallcharbossapi.callback.OverwriteCardEnergyOrb;
...
public class AbstractBossCardPatches {
    ...
    public static class RenderCardBgPatch {
        ...
        public static SpireReturn<?> Prefix(AbstractCard __instance, SpriteBatch sb, float xPos, float yPos, Color ___renderColor) {
            ...
            OverwriteCardBackground overwriteCardBackground = __instance instanceof OverwriteCardBackground ? (OverwriteCardBackground) __instance : null;
            Texture texture = overwriteCardBackground != null ? overwriteCardBackground.getBackgroundTexture() : null;
            TextureAtlas.AtlasRegion region = overwriteCardBackground != null ? overwriteCardBackground.getBackgroundAtlasRegion() : null;
            ...
            if (region == null) {
                DownfallCharBossApi.logger.info(color.toString() + " texture is null wtf");
                return SpireReturn.Continue();
            }
            ...
            try {
                ...
                DownfallCharBossApi.logger.warn(e);
                return SpireReturn.Continue();
            }
        }
    }
    ...
    public static class RenderEnergyPatch
    {
        ...
        public static TextureAtlas.AtlasRegion getEnergyOrb(AbstractCard card, TextureAtlas.AtlasRegion orb)
        {
            ...
            OverwriteCardEnergyOrb overwriteCardoverwriteCardEnergyOrb = card instanceof OverwriteCardEnergyOrb ? (OverwriteCardEnergyOrb) card : null;
            if (overwriteCardoverwriteCardEnergyOrb != null) {
                TextureAtlas.AtlasRegion region = overwriteCardoverwriteCardEnergyOrb.getEnergyOrbAtlasRegion();
                Texture texture = overwriteCardoverwriteCardEnergyOrb.getEnergyOrbTexture();
                if (texture != null) {
                    region = new TextureAtlas.AtlasRegion(texture, 0, 0, texture.getWidth(), texture.getHeight());
                }
                if (region != null) {
